...
const MOCK: MarketplacePartDTO[] = [
  ...
  P("eng-1", "Motor 1.6L 16v reconstruido", "engine", "Nissan", "reconstruido", 38500, {
    original_price: 45000, stock: 3, rating: 4.7, reviews: 28, warranty_months: 6, accent_from: "#ff5d73", accent_to: "#ff9b3d",
  ...
  P("eng-2", "Motor 2.0 TSI turbo seminuevo", "engine", "Volkswagen", "usado", 64900, {
    stock: 1, rating: 4.4, reviews: 12, free_shipping: false, warranty_months: 3, accent_from: "#5b6cff", accent_to: "#9b5bff",
  ...
  P("tir-1", "Llanta 205/55 R16 (juego de 4)", "tires", "Michelin", "nuevo", 7600, {
    stock: 24, rating: 4.9, reviews: 210, accent_from: "#22e0ff", accent_to: "#2ee6a6",
  ...
  P("tir-2", "Llanta 195/65 R15 (juego de 4)", "tires", "Goodyear", "nuevo", 6200, {
    original_price: 7000, stock: 16, rating: 4.6, reviews: 98, accent_from: "#2ee6a6", accent_to: "#22e0ff",
  ...
  P("sea-1", "Asiento delantero de piel", "seats", "OEM", "usado", 4300, {
    stock: 5, rating: 4.2, reviews: 17, free_shipping: false, warranty_months: 0, accent_from: "#9fb0d0", accent_to: "#3d6bff",
  ...
  P("sea-2", "Par de asientos deportivos", "seats", "Recaro", "nuevo", 18900, {
    stock: 2, rating: 4.8, reviews: 34, accent_from: "#ff5d73", accent_to: "#5b6cff",
    specs: [{ label: "Tipo", value: "Deportivo" }, { label: "Piezas", value: "2" }],
  }),
  // Baterías
  P("bat-1", "Batería LTH Grupo 35 · 600 CCA", "battery", "LTH", "nuevo", 2890, {
    stock: 30, rating: 4.7, reviews: 156, accent_from: "#3d6bff", accent_to: "#22e0ff",
  ...
  P("bat-2", "Batería Bosch S4 Grupo 42 · 700 CCA", "battery", "Bosch", "nuevo", 3450, {
    stock: 14, rating: 4.8, reviews: 89, accent_from: "#22e0ff", accent_to: "#5b6cff",
  ...
  P("fus-1", "Kit de fusibles Mini (surtido 120 pzs)", "fuse", "Littelfuse", "nuevo", 320, {
    stock: 200, rating: 4.9, reviews: 320, accent_from: "#2ee6a6", accent_to: "#22e0ff",
  ...
  P("fus-2", "Fusibles Blade surtido (80 pzs)", "fuse", "Bosch", "nuevo", 240, {
    stock: 150, rating: 4.7, reviews: 142, accent_from: "#3d6bff", accent_to: "#2ee6a6",
  ...
  P("brk-1", "Balatas cerámicas delanteras", "brakes", "Brembo", "nuevo", 1290, {
    stock: 40, rating: 4.8, reviews: 76, accent_from: "#ff5d73", accent_to: "#ff9b3d",
  ...
  P("brk-2", "Discos de freno ventilados (par)", "brakes", "ATE", "nuevo", 2150, {
    original_price: 2600, stock: 18, rating: 4.6, reviews: 51, accent_from: "#5b6cff", accent_to: "#22e0ff",
    specs: [{ label: "Tipo", value: "Ventilado" }, { label: "Piezas", value: "2" }],
  }),
  // Suspensión
  P("sus-1", "Amortiguadores delanteros (par)", "suspension", "Monroe", "nuevo", 3380, {
    stock: 12, rating: 4.5, reviews: 44, accent_from: "#9fb0d0", accent_to: "#3d6bff",
  ...
  P("sus-2", "Kit de horquillas y rótulas", "suspension", "Moog", "reconstruido", 2480, {
    stock: 6, rating: 4.3, reviews: 22, warranty_months: 6, accent_from: "#22e0ff", accent_to: "#5b6cff",
    specs: [{ label: "Incluye", value: "Horquillas + rótulas" }],
  }),
  // Aceites
  P("oil-1", "Aceite sintético 5W-30 (4L)", "oil", "Mobil 1", "nuevo", 690, {
    stock: 120, rating: 4.9, reviews: 410, accent_from: "#2ee6a6", accent_to: "#22e0ff",
  ...
  P("oil-2", "Aceite semisintético 10W-40 (5L)", "oil", "Castrol", "nuevo", 540, {
    stock: 90, rating: 4.6, reviews: 188, accent_from: "#3d6bff", accent_to: "#2ee6a6",
  ...
  P("lig-1", "Faro delantero LED (lado izq.)", "lights", "Philips", "nuevo", 2890, {
    stock: 9, rating: 4.5, reviews: 37, accent_from: "#22e0ff", accent_to: "#9b5bff",
    specs: [{ label: "Tecnología", value: "LED" }, { label: "Lado", value: "Izquierdo" }],
  }),
  P("lig-2", "Kit de halógenos H4 (par)", "lights", "Osram", "nuevo", 380, {
    stock: 60, rating: 4.4, reviews: 64, free_shipping: false, accent_from: "#ff9b3d", accent_to: "#ff5d73",
  ...
  P("aud-2", "Bocinas 6.5\" 2 vías (par)", "audio", "JBL", "nuevo", 1290, {
    stock: 33, rating: 4.6, reviews: 142, accent_from: "#3d6bff", accent_to: "#2ee6a6",
