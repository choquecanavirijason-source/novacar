...
const MOCK: MarketplacePartDTO[] = [
  ...
  P("eng-2", "Motor 2.0 TSI turbo seminuevo", "engine", "Volkswagen", "usado", 64900, {
    stock: 1, rating: 4.4, reviews: 12, free_shipping: false, warranty_months: 3, accent_from: "#2f8f88", accent_to: "#3fa89a",
  ...
  P("tir-1", "Llanta 205/55 R16 (juego de 4)", "tires", "Michelin", "nuevo", 7600, {
    stock: 24, rating: 4.9, reviews: 210, accent_from: "#1bc4b6", accent_to: "#2fae95",
  ...
  P("tir-2", "Llanta 195/65 R15 (juego de 4)", "tires", "Goodyear", "nuevo", 6200, {
    original_price: 7000, stock: 16, rating: 4.6, reviews: 98, accent_from: "#2fae95", accent_to: "#1bc4b6",
  ...
  P("sea-1", "Asiento delantero de piel", "seats", "OEM", "usado", 4300, {
    stock: 5, rating: 4.2, reviews: 17, free_shipping: false, warranty_months: 0, accent_from: "#9a9c97", accent_to: "#10827e",
  ...
  P("sea-2", "Par de asientos deportivos", "seats", "Recaro", "nuevo", 18900, {
    stock: 2, rating: 4.8, reviews: 34, accent_from: "#ff6b6b", accent_to: "#2f8f88",
    specs: [{ label: "Tipo", value: "Deportivo" }, { label: "Piezas", value: "2" }],
  }),
  // Baterías
  P("bat-1", "Batería LTH Grupo 35 · 600 CCA", "battery", "LTH", "nuevo", 2890, {
    stock: 30, rating: 4.7, reviews: 156, accent_from: "#10827e", accent_to: "#1bc4b6",
  ...
  P("bat-2", "Batería Bosch S4 Grupo 42 · 700 CCA", "battery", "Bosch", "nuevo", 3450, {
    stock: 14, rating: 4.8, reviews: 89, accent_from: "#1bc4b6", accent_to: "#2f8f88",
  ...
  P("fus-1", "Kit de fusibles Mini (surtido 120 pzs)", "fuse", "Littelfuse", "nuevo", 320, {
    stock: 200, rating: 4.9, reviews: 320, accent_from: "#2fae95", accent_to: "#1bc4b6",
  ...
  P("fus-2", "Fusibles Blade surtido (80 pzs)", "fuse", "Bosch", "nuevo", 240, {
    stock: 150, rating: 4.7, reviews: 142, accent_from: "#10827e", accent_to: "#2fae95",
  ...
  P("brk-2", "Discos de freno ventilados (par)", "brakes", "ATE", "nuevo", 2150, {
    original_price: 2600, stock: 18, rating: 4.6, reviews: 51, accent_from: "#2f8f88", accent_to: "#1bc4b6",
    specs: [{ label: "Tipo", value: "Ventilado" }, { label: "Piezas", value: "2" }],
  }),
  // Suspensión
  P("sus-1", "Amortiguadores delanteros (par)", "suspension", "Monroe", "nuevo", 3380, {
    stock: 12, rating: 4.5, reviews: 44, accent_from: "#9a9c97", accent_to: "#10827e",
  ...
  P("sus-2", "Kit de horquillas y rótulas", "suspension", "Moog", "reconstruido", 2480, {
    stock: 6, rating: 4.3, reviews: 22, warranty_months: 6, accent_from: "#1bc4b6", accent_to: "#2f8f88",
    specs: [{ label: "Incluye", value: "Horquillas + rótulas" }],
  }),
  // Aceites
  P("oil-1", "Aceite sintético 5W-30 (4L)", "oil", "Mobil 1", "nuevo", 690, {
    stock: 120, rating: 4.9, reviews: 410, accent_from: "#2fae95", accent_to: "#1bc4b6",
  ...
  P("oil-2", "Aceite semisintético 10W-40 (5L)", "oil", "Castrol", "nuevo", 540, {
    stock: 90, rating: 4.6, reviews: 188, accent_from: "#10827e", accent_to: "#2fae95",
  ...
  P("lig-1", "Faro delantero LED (lado izq.)", "lights", "Philips", "nuevo", 2890, {
    stock: 9, rating: 4.5, reviews: 37, accent_from: "#1bc4b6", accent_to: "#3fa89a",
  ...
  P("lig-3", "Faro LED para motocicleta", "lights", "DKR", "nuevo", 1820, {
    stock: 10, rating: 4.7, reviews: 41, accent_from: "#ff6b6b", accent_to: "#1bc4b6",
  ...
  P("fil-1", "Filtro de aire de alto flujo", "filters", "K&N", "nuevo", 760, {
    stock: 48, rating: 4.7, reviews: 120, accent_from: "#2fae95", accent_to: "#10827e",
    specs: [{ label: "Tipo", value: "Aire" }, { label: "Reutilizable", value: "Sí" }],
  }),
  P("fil-2", "Kit filtros aceite + cabina", "filters", "Mann", "nuevo", 410, {
    stock: 70, rating: 4.6, reviews: 88, accent_from: "#10827e", accent_to: "#1bc4b6",
  ...
  P("bod-1", "Cofre/capó de lámina", "body", "OEM", "usado", 5200, {
    stock: 3, rating: 4.1, reviews: 9, free_shipping: false, warranty_months: 0, accent_from: "#9a9c97", accent_to: "#2f8f88",
    specs: [{ label: "Pieza", value: "Cofre" }, { label: "Material", value: "Lámina" }],
  }),
  P("bod-2", "Espejo lateral eléctrico (der.)", "body", "OEM", "nuevo", 1480, {
    stock: 11, rating: 4.5, reviews: 26, accent_from: "#2f8f88", accent_to: "#1bc4b6",
    specs: [{ label: "Pieza", value: "Espejo" }, { label: "Lado", value: "Derecho" }],
  }),
  // Audio
  P("aud-1", "Estéreo Android 9\" CarPlay", "audio", "Pioneer", "nuevo", 4200, {
    original_price: 5100, stock: 15, rating: 4.8, reviews: 175, accent_from: "#1bc4b6", accent_to: "#2f8f88",
  ...
  P("aud-2", "Bocinas 6.5\" 2 vías (par)", "audio", "JBL", "nuevo", 1290, {
    stock: 33, rating: 4.6, reviews: 142, accent_from: "#10827e", accent_to: "#2fae95",
