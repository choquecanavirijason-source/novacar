...
export const toCatalogVehicle = (dto: CatalogVehicleDTO): CatalogVehicle => ({
  ...
  seats: dto.seats,
  topSpeedKmh: dto.top_speed_kmh,
  zeroToHundredSec: dto.zero_to_hundred_sec,
  availability: dto.availability as CatalogVehicle["availability"],
...
export const toCatalogVehiclePayload = (input: NewCatalogVehicle) => ({
  ...
  seats: input.seats,
  top_speed_kmh: input.topSpeedKmh,
  zero_to_hundred_sec: input.zeroToHundredSec,
